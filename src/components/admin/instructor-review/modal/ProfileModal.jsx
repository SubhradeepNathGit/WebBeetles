                ...
                <div
                    ...
                    <div className="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {modal?.expertise?.map((e, i) => (
                                    <span key={i} className="text-xs bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2.5 py-1 rounded-md font-medium">
                                        {e}
                                    </span>
                                ))}
                            </div>
                        ...
                        <div className="bg-[#1a1a1a] rounded-xl p-4 border border-white/5 flex items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                <FileText size={28} className="text-emerald-500/60 flex-shrink-0" />
                                <div>
                    ...
                    <div className="p-5 border-t border-white/5 flex items-center justify-end gap-3 bg-[#0d0d0d] rounded-b-2xl">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl transition-colors text-sm font-semibold shadow-lg shadow-emerald-500/20 cursor-pointer"
                        >
