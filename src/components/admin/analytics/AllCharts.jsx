...
const AllCharts = ({ revenueData, lineOpts, enrollData, barOpts, completionData, completionOpts, mauData, mauOpts, catData, doughnutOpts }) => {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <ChartCard title="Monthly Enrollments" subtitle="Number of new course enrollments per month">
                <Bar data={enrollData} options={barOpts} />
            </ChartCard>
            <ChartCard title="Course Completion Rate" subtitle="Simplified average completion % across all published courses">
