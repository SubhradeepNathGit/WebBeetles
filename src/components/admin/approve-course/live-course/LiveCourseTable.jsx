...
const LiveCourseTable = ({ approved, setPreview, setOpenBlockUnblockModal, setBlockUnblockCourseId, setBlockUnblockChangeStatus }) => {
    return (
        <div className="bg-[#111] rounded-2xl overflow-hidden border border-white/5 shadow-2xl">
            ...
            <div className="divide-y divide-white/5 max-h-[205px] overflow-y-auto">
                {approved.map(c => (
                    <LiveCourseRow key={c.id} c={c} setPreview={setPreview} setOpenBlockUnblockModal={setOpenBlockUnblockModal} setBlockUnblockCourseId={setBlockUnblockCourseId}
