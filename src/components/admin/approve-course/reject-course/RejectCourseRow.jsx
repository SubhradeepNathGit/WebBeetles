...
const RejectCourseRow = ({ c }) => {
    return (
        <div className="px-6 py-4 flex items-center gap-4 hover:bg-white/[0.02] transition-colors group">
            ...
            <span className="text-xs bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2.5 py-1 rounded-md hidden sm:block">{c?.category?.name ?? 'N/A'}</span>
