        ...
        <div className="bg-[#111] p-5 rounded-2xl border border-white/5 shadow-xl">
            ...
            <div className="space-y-2.5">
                {[
                    ...
                    <Link key={i} to={action.to} className="flex items-center justify-between w-full px-4 py-2.5 bg-[#161616] hover:bg-[#1e1e1e] rounded-xl transition-all group border border-transparent hover:border-emerald-500/20">
                        <div className="flex items-center gap-2.5 text-gray-400 group-hover:text-white transition-colors">
                            <span className="text-emerald-400 group-hover:text-yellow-400 transition-colors">{action.icon}</span>
