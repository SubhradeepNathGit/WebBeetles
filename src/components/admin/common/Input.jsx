        ...
        <div>
            ...
            <div className="relative">
                <input disabled
                    ...
                    className={`w-full pl-4 pr-10 py-2.5 bg-[#1a1a1a] border border-white/5 rounded-xl text-white font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all text-sm
