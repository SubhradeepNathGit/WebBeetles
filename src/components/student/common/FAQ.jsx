...
const FAQSection = () => {
  ...
  return (
    <section className="bg-black text-white py-12 sm:py-16 lg:py-4">
      <motion.div
        ref={ref}
        initial="hidden"
        animate={isInView ? "visible" : "hidden"}
        variants={containerVariants}
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-start"
      >
        {/* Left Section */}
        <motion.div 
        ...
        >
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-3xl p-6 sm:p-8 max-w-md">
            ...
            <Link to='/contact' className="inline-flex items-center gap-2 sm:gap-3 bg-transparent border border-gray-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full font-medium hover:bg-gray-800 transition-all duration-200 group text-sm sm:text-base">
              Ask a Question 
          ...
          {faqData.map((faq, index) => {
            ...
            return (
              <motion.div
                ...
                } ${isLast ? 'mb-7' : ''}`} // extra space after last accordion
              >
                <button
