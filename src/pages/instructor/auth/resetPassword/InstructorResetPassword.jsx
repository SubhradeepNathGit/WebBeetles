...
const InstructorResetPassword = () => {
    ...
    const handleResend = () => {
        ...
        dispatch(resendOTPSlice({ ...resend_obj, userType: 'instructor' }))
            .then(res => {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen w-full relative bg-gradient-to-b from-rose-900 to-black">
            ...
            {/* Right Panel — Reset Password Form (scrollable) */}
            <div className="w-full md:w-1/2 h-screen bg-transparent overflow-y-auto custom-scrollbar relative">
                ...
                <div className="relative z-10 w-full max-w-md mx-auto px-6 sm:px-10 py-10 lg:py-14">
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit(forgetPasswordDataHandler)}>
                        {!urlToken && (
                            <>
                                ...
                                <div className="flex flex-col items-center mt-4">
                                    {disabled ? (
                                        ...
                                        <button type="button" onClick={() => handleResend(email)} className="text-rose-300 text-sm font-medium hover:text-rose-100 transition-colors">
                                            Resend OTP
                                        </button>
                                    )}
                                </div>
                        ...
                        <div className="flex flex-col mt-4">
                            ...
                            <input type="password" autoComplete='new-password' placeholder="Enter password" {...register('cpwd')} className="w-full rounded-xl px-5 py-3 text-sm text-white placeholder-gray-500 bg-white/5 border border-white/10 focus:outline-none focus:ring-2 focus:ring-rose-500 transition-all mb-0" />
                        </div>
