                        ...
                        <div className="w-fit mx-auto flex flex-col items-center">
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <input
                                                ...
                                                maxLength={1}
                                                autoComplete='off'
                                                className="w-11 h-12 sm:w-13 sm:h-14 md:w-14 md:h-16 text-center rounded-xl border border-white/20 text-xl font-bold text-white bg-white/5 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-transparent focus:bg-white/10 transition-all duration-200 shadow-inner"
                                                onChange={(e) => {
                            ...
                            <div className="flex flex-col items-center mt-5">
                                {disabled ? (
                                    ...
                                    <button type="button" disabled={isUserAuthLoading} onClick={() => handleResend(email)} className="text-rose-300 text-sm font-medium hover:text-white cursor-pointer transition-colors duration-200">
                                        Resend OTP
                                    </button>
                                )}
                            </div>
                            ...
                            <button
                                ...
                                className={`w-full mt-6 py-3.5 rounded-xl text-base font-semibold text-white tracking-wide transition-all duration-300 ${isUserAuthLoading ? 'bg-rose-500/40 cursor-not-allowed opacity-70' : 'cursor-pointer bg-gradient-to-r from-rose-600 via-rose-500 to-red-600 hover:from-rose-500 hover:via-rose-400 hover:to-red-500 shadow-lg shadow-rose-600/20 hover:shadow-rose-500/40 hover:scale-[1.02] active:scale-[0.98]'}`}
                            >
