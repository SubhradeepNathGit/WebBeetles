  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 md:px-10">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(#ea5645,#ec0505), url('/auth/signup/2d50b5e330e23a5e512b5bf08a4c93babfc9d528.png')",
          ...
          <div className="w-full max-w-lg px-8 bg-white/10 backdrop-blur-sm rounded-2xl py-2 shadow-2xl">
            ...
            <form className="space-y-4" onSubmit={handleSubmit(registerDataHandler)}>
              ...
              <div className="relative mb-0">
                ...
                >
                  {confirmShow ? <FaRegEyeSlash className='text-[#ec0505] cursor-pointer' /> : <FaRegEye className='text-[#ec0505] cursor-pointer' />}
                </button>
              </div>
    ...
    ${isUserAuthLoading ? "bg-blue-400 cursor-not-allowed opacity-70" : "cursor-pointer bg-red-600 hover:bg-red-700 hover:border-2 hover:border-white"}`}>
            ...
            <p className="text-center text-white/80 mt-3 text-sm">
              ...
              <Link to="/instructor/signin" className="text-red-900 font-bold hover:text-[#fff]">
                Log in
              </Link>
            </p>
